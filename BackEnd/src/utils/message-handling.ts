...
const usernameHaveAtLeast3Character: string =
...
const passwordAndRetypePasswordNotSame: string =
  'Mật khẩu và nhập lại mật khẩu phải giống nhau';
const passwordHasAtLeast1Character: string = 'Mật khẩu phải có ít nhất 1 ký tự';
const nameHaveAtLeast1Character: string =
  'Tên người dùng phải có tối thiểu 1 ký tự';
const userNotActive: string = 'Tài khoản chưa được kích hoạt';
